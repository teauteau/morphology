"""
Django settings for MorphoAi project.
...
SECRET_KEY = 'django-insecure-aop$vt@ddrhq0-zrb5j5v_83h=%29o#xy1ax(6nj4t&!-w&x-s'
...
MIDDLEWARE = [
    'webapp.middleware.StoreRequestMiddleware',
...
WSGI_APPLICATION = 'MorphoAi.wsgi.application'
